...
type
  TfMain = class(TForm)
    ...
    cbOpti: TCheckBox;
    lGrille: TLabel;
    btnSetupGrille: TButton; // <-- ÍÎÂÀß ÊÍÎÏÊÀ ÄËß ÂÛÇÎÂÀ ÔÎÐÌÛ
    ...
    procedure btnSetupGrilleClick(Sender: TObject); // <-- ÎÁÐÀÁÎÒ×ÈÊ ÍÎÂÎÉ ÊÍÎÏÊÈ
  private
...
begin
  ...
  begin
    ...
    ShowMessage('Òðàôàðåò óñïåøíî çàäàí!');
  end;
end;
