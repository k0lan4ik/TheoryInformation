object fMain: TfMain
  Left = 0
  Top = 0
  Caption = #1050#1088#1091#1090#1086#1081' '#1064#1080#1092#1088#1072#1090#1086#1088
  ClientHeight = 526
  ClientWidth = 688
  Color = clBtnFace
  Constraints.MaxHeight = 565
    ...
    object tsGrile: TTabSheet
      ...
      object pgControl: TPanel
        ...
        object cgSelectMode: TComboBox
          ...
          ItemIndex = 0
          TabOrder = 2
          Text = #1064#1080#1092#1088#1086#1074#1072#1085#1080#1077
          Items.Strings = (
            #1064#1080#1092#1088#1086#1074#1072#1085#1080#1077
            #1044#1077#1096#1080#1092#1088#1086#1074#1072#1085#1080#1077)
        end
        object bgOpen: TButton
          Left = 1
          Top = 66
          Width = 337
          Height = 25
    ...
    object tsVigener: TTabSheet
      ...
      object pvControl: TPanel
        ...
        object lvKey: TLabel
          ...
          Width = 76
          Height = 15
          Caption = #1042#1099#1073#1086#1088' '#1082#1083#1102#1095#1072
        end
        object lvMode: TLabel
          Left = 144
          Top = 6
          Width = 84
          Height = 15
  ...
  object stfDialog: TSaveTextFileDialog
  ...
  object otfDialog: TOpenTextFileDialog
    Filter = #1058#1077#1082#1089#1090#1086#1074#1099#1077' '#1092#1072#1081#1083#1099' (*.txt)|*txt|'#1042#1089#1077' '#1092#1072#1081#1083#1099' (*.*)|*.*'
    Left = 612
    Top = 2
  end
